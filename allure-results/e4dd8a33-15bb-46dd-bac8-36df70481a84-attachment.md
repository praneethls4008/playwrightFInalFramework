...
- Name: ui/full-page-tests/fullPageRegression.spec.ts >> LAMBDATEST_ECOMMERCE >> Check status code
- Location: tests/ui/full-page-tests/fullPageRegression.spec.ts:37:13

# Error details

```
Error: page.goto: Error resolving “ecommerce-playground.lambdatest.io”: Name or service not known
Call log:
