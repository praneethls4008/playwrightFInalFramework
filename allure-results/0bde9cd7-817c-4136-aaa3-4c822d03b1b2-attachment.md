...
=========================== logs ===========================
waiting for navigation to "https://qaplayground.com/auth/sign-in" until "load"
  navigated to "https://qaplayground.com/"
============================================================
```
...
> 32 |           page.waitForURL(QAPlaygroundHeaderData.loginBtnHref, { waitUntil: 'load' }),
     |                ^ Error: page.waitForURL: Test ended.
