...
```
Error: banner text is not as expected

expect(received).toBe(expected) // Object.is equality

Expected: "QA Playground"
Received: Promise {}
```

```
Error: banner link is not as expected
...
```
Error: Menu Items are not as expected

expect(received).toEqual(expected) // deep equality

Expected: [{"href": "/", "text": "Home"}, {"href": "/practice", "text": "Practice"}, {"href": "/demo", "text": "Demo Apps"}, {"href": "/challenges", "text": "Challenges"}, {"href": "/blog", "text": "Blogs"}]
Received: Promise {}
```
...
```ts
  ...
  10 |       async() => {
  11 |         const actualBannerText = headerComponent.getBannerText();
  12 |         expect.soft(actualBannerText, 'banner text is not as expected').toBe(QAPlaygroundHeaderData.banner.text);
  13 | 
  14 |         const actualBannerLink = headerComponent.getBannerLink();
  ...
  21 |       async() => {
  22 |         const actualMenusItems = headerComponent.getMenuLinks();
  ...
  30 |       async() => {
  31 |         const actualRedirectedPageUrl = headerComponent.clickLoginOrSignupBtn();
